...
const handlers = {
    ...
    'SearchFlights': function () {
...

        {
            ...
            var fromSimilarCity = airportCodes.getSimilaryCityName(this.event.request.intent.slots.fromCity.value);
            var toSimilarCity = airportCodes.getSimilaryCityName(this.event.request.intent.slots.toCity.value);

            console.log("****************************.  Early City Values. ************************************");
            console.log("FromCity --> " + this.event.request.intent.slots.fromCity.value);
            console.log("toCity --> " + this.event.request.intent.slots.toCity.value);
            console.log("*************************************************************************************");
            


            console.log("*****************************.   New City Values ****************************************");
            console.log("FromCity --> " + fromSimilarCity);
            console.log("toCity --> " + toSimilarCity);
            console.log("*************************************************************************************");


            var myFlightDate = this.event.request.intent.slots.mydate.value;

            var fromCity=airportCodes.getCodeFromCity(fromSimilarCity);
            var toCity= airportCodes.getCodeFromCity(toSimilarCity);

            var myFlightType="search";

            console.log("SearchFlights" + fromCity + '/'+ toCity + '/'  + '/' + myFlightDate);


            if((this.event.request.intent.slots.flightType).hasOwnProperty('value')){

               console.log("***************************** MY FLIGHT TYPES ***************************************");
               
               // myFlightType  = airportCodes.getSimilarFlightType(this.event.request.intent.slots.flightType.value);
               myFlightType  = this.event.request.intent.slots.flightType.value;
               console.log(myFlightType);

               if(myFlightType.toLowerCase() == "cheap" || myFlightType.toLowerCase() == "cheapest"){
               ...
               else if(myFlightType.toLowerCase() == "alternate" || myFlightType.toLowerCase() == "alternative"){
    ...
    'Weatherstatus': function () {
     ...
     'TerminalInfo': function () {
        ...
        if (this.event.request.dialogState === 'STARTED') {
            ...
            var fromSimilarTerminalCity = airportCodes.getSimilarTerminalCityName(this.event.request.intent.slots.fromCity.value);
            myContext.response.speak(functions.getMyTerminalInfo(fromSimilarTerminalCity)).listen(repromptText);
            myContext.emit(':responseReady'); 
        }
    },
